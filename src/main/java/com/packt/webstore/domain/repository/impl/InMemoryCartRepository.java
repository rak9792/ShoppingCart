...
public class InMemoryCartRepository implements CartRepository 
{
	...
	public void create(CartDto cartDto) 
	{
		...
		cartDto.getCartItems().stream().forEach(CartItemDto->{Product productById=productService.getProductById(CartItemDto.getProductId());String INSERT_CART_ITEM_SQL="INSERT INTO CART_ITEM(ID,PRODUCT_ID,CART_ID,QUANTITY)" + "VALUES( :id, :product_id, :cart_id, :quantity)"; Map<String,Object> cartItemsParams=new HashMap<String,Object>();cartItemsParams.put("id", CartItemDto.getId()); cartItemsParams.put("product_id", productById.getProductId());cartItemsParams.put("cart_id", cartDto.getId());cartItemsParams.put("quantity", CartItemDto.getQuantity());jdbcTemplate.update(INSERT_CART_ITEM_SQL, cartItemsParams);});
	}
