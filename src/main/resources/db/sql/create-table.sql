...
BILLING_ADDRESS_ID INTEGER FOREIGN KEY RFERENCES ADDRESS(ID)
);
...
SHIPPING_ADDRESS INTEGER FOREIGN KEY REFERENCES ADDRESS(ID)
);
...
SHIPPING_DETAIL INTEGER FOREIGN KEY REFERENCES SHIPPING_DETAIL(ID)
);
